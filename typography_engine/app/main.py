...
def privacy():
    blocks = [
        ...
        ("Sharing and sub-processors", "<p>We share data only with the providers needed to run Typortrait: <b>Stripe</b> (payments), <b>Printful</b> (print fulfilment, physical orders only), our <b>hosting provider</b>, and privacy-first, cookieless <b>Umami</b> analytics, and <b>OpenAI</b> (content moderation &mdash; it screens the words you type to enforce our Terms; it does not receive your photo). We <b>do not sell or &ldquo;share&rdquo;</b> your personal information (as those terms are defined under U.S. state privacy laws), and we do not use it for cross-context behavioural advertising. We may disclose information if required by law.</p>"
